#ifndef _DEVICE_GEONAUTE500HR_HPP_
#define _DEVICE_GEONAUTE500HR_HPP_
...
{
	/**
	  The interface for OnMove 500HR GPS watch.
	 */
	class OnMove500HR : public Device
	{
		public:
			OnMove500HR() {};
			...
			std::string getName() override { return "OnMove500HR"; };
			DeviceId getDeviceId() override { return { 0x283E, 0x0009 }; };

		private:
			std::string getPath();
			DECLARE_DEVICE(OnMove500HR);
	};
}
